        ...
        index: function () {
            layui.use(['table', 'layer', 'laydate', 'form'], function () {
                ...
                table.render({
                    id: 'testReload'
                    , elem: '#demo'
                    , url: tchost + '/tcstore/tcStatistics/selectDeviceSaleData' //数据接口
                    , method: "get"
                    ...
                    , cols: [[ //表头
                        ...
                        , {field: 'adminName', title: '所属商户', width: '200',align:'center'}
                        , {field: 'orderCount', title: '订单量', width: '250',sort: true,align:'center'}
                        , {field: 'averagePrice', title: '客单价', width: '200',sort: true,align:'center'}
                        , {field: 'sumSalePrice', title: '总收入', width: '200',sort: true,align:'center'}
                        , {field: 'sumOrigPrice', title: '优惠前金额', width: '200',sort: true,align:'center'}
                        , {field: 'sumDiscPrice', title: '优惠金额', width: '200',sort: true,align:'center'}
                    ]]
                });
                        ...
                        case 'out':
                            ...
                            layer.confirm('选择导出数据', {
                                ...
                                btn1: function (index) {
                                    ...
                                    url = tchost + "/tcstore/tcStatistics/deviceSaleDataExcelExportList?deviceName=" + deviceName +
                                        '&deviceId=' + deviceId + '&adminName=' + adminName +
