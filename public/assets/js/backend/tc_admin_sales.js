        ...
        index: function () {
            layui.use(['table', 'layer', 'laydate', 'form'], function () {
                ...
                table.render({
                    id: 'testReload'
                    , elem: '#demo'
                    , url: tchost + '/tcstore/tcStatistics/selectAdminSaleData' //数据接口
                    , method: "get"
                    ...
                    , defaultToolbar: []
                    , cols: [[ //表头
                        {field: 'adminName', title: '商户名称', width: '200',align:'center'}
                        , {field: 'deviceCount', title: '运营设备数', width: '200',sort: true,align:'center'}
                        , {field: 'sumSaleAmount', title: '销售额', width: '200',sort: true,align:'center'}
                        , {field: 'averageDeviceAmount', title: '设备平均销售额',sort: true, width: '350',align:'center'}
                    ]]
                });
