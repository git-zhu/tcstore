...
class Service
{
     ...
     * @throws Exception
     */
    public static function submitOrder($amount,$payee_info=null, $orderid = null, $type = null, $title = null, $notifyurl = null, $returnurl = null, $method = null, $redirect = true)
    {
        if (!is_array($amount)) {
            $params = [
                'amount'    => $amount,
        ...
        if ($type == 'alipay') {
            ...
            switch ($method) {
                ...
                case 'transfer':
                    //账户转账
                    $params['out_biz_no'] =$orderid;
                    $params['trans_amount'] = $amount;
                    $params['product_code'] = "TRANS_ACCOUNT_NO_PWD";
                    $params['payee_info'] = $payee_info;
                    $html = $pay->transfer($params);
                    break;
                default:
